                ...
                >
                  ...
                  >
                    <figure
                      ...
                      className="h-64 bg-cover bg-center group-hover:bg-[#F87060]"
                    />
                    {/* Animal details */}
                    <div className="card-body shadow-lg flex-1 flex flex-col justify-between bg-base-100 group-hover:bg-[#F87060] group-hover:text-[#102542]">
                      <div className="flex flex-col h-full justify-between">
                        <div>
                          <h2 className="card-title mb-4 group-hover:text-[#102542]">
                            {animal.name}
                          </h2>
                          <p className="mb-2 group-hover:text-[#102542]">
                          ...
                          <p className="mb-2 group-hover:text-[#102542]">
                            Approximate Age: {animal.age}{" "}
                            {animal.age > 1 ? "years" : "year"}
                          </p>
                          <p className="mb-2 group-hover:text-[#102542]">
