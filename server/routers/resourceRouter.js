...
resourceRouter.post('/resources', isAuthenticated, isAdminManagerorStaff, async (req, res) => {
    try {
...
resourceRouter.put('/resources/:id', isAuthenticated, isAdminManagerorStaff, async (req, res) => {
    try {
        const { id } = req.params;
...
resourceRouter.delete('/resources/:id', isAuthenticated, isAdminManagerorStaff, async (req, res) => {
    try {
        const { id } = req.params;
